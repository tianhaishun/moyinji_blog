...
- **触摸手势**：相册灯箱支持左右滑动切换照片
- **自适应布局**：响应式网格、灵活间距、动态字体
- **大触摸目标**：所有交互元素最小 44×44px，符合 iOS/Android 规范
- **触摸反馈**：按下时的视觉反馈，提升操作体验
- **安全区域适配**：支持带刘海屏的设备（iPhone X 及以上）
- **性能优化**：移动端减少阴影效果，加快动画速度
- **可访问性**：支持减少动画偏好设置，完整的键盘导航
...
> 💡 **详细开发规范**：请查看 [DEVELOPMENT_GUIDE.md](DEVELOPMENT_GUIDE.md) 获取完整的设计规范、组件标准和最佳实践。
